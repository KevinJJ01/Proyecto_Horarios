...
<<<<<<< HEAD
    ...
    Id_Ficha= db.Column(db.Integer,
                          db.ForeignKey('id_Ficha'))
    Id_Tranversal= db.Column(db.Integer,
                          db.ForeignKey('id_Transversal'))
    Id_Ambiente= db.Column(db.Integer,
                          db.ForeignKey('id_Ambiente'))
    Id_Instructor= db.Column(db.Integer,
                          db.ForeignKey('id_Instructor'))
